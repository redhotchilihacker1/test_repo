...
# ExcelWriter ile sonuçları tek bir .xlsx dosyasına, her .nessus dosyası için ayrı sheet'e kaydetmek için bir writer oluştur
...
with pd.ExcelWriter(xlsx_output, engine='xlsxwriter') as writer:
    ...
    for nessus_file in nessus_files:
        ...
        # Her .nessus dosyasını ayrı bir sheet olarak kaydet
        sheet_name = os.path.splitext(nessus_file)[0]  # Dosya adını sheet adı olarak kullan
